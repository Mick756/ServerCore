...
import net.arcadia.command.admin.*;
import net.arcadia.command.donor.FireworkCMD;
import net.arcadia.command.donor.MvpCMD;
import net.arcadia.command.donor.NickCMD;
import net.arcadia.command.donor.VipCMD;
import net.arcadia.command.economy.BalanceCMD;
import net.arcadia.command.economy.BalanceEditCMD;
import net.arcadia.command.economy.PayCMD;
import net.arcadia.command.economy.shop.CreateShopCMD;
import net.arcadia.command.economy.shop.DeleteShopCMD;
import net.arcadia.command.global.*;
import net.arcadia.command.kit.CreateKitCMD;
import net.arcadia.command.kit.DeleteKitCMD;
import net.arcadia.command.kit.KitCMD;
import net.arcadia.command.permission.PermCMD;
import net.arcadia.command.permission.PermListCMD;
import net.arcadia.command.player.gamemode.*;
import net.arcadia.command.player.health.FeedCMD;
import net.arcadia.command.player.health.HealCMD;
import net.arcadia.command.report.ReportBugCMD;
import net.arcadia.command.report.ReportCMD;
