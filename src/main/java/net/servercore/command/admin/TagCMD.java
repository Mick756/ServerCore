...
//
//						player.setCustomTag(null);
//						player.changeGroup("Member");
//
...
//							player.sendMessage(true, "&cThis tag was blocked because it contained inappropriate language!");
//							return;
//						}
//
//						player.setCustomTag(cTag);
//						player.updateNameDisplay();
//
