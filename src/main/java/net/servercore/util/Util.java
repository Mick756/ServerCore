...
public class Util {
	...
	public static void doAsync(Runnable runnable) {
		Bukkit.getScheduler().runTaskAsynchronously(ServerCore.getInstance(), runnable);
	}
	
	public static void doSync(Runnable runnable) {
		Bukkit.getScheduler().runTask(ServerCore.getInstance(), runnable);
	}
	
	public static void doLater(Runnable runnable, long time) {
		Bukkit.getScheduler().runTaskLater(ServerCore.getInstance(), runnable, time);
	}
